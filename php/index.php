...
<body>
	...
	<span>
             ...
             <div><p>
			 <input type="button" value = "登录" onclick="location.href='./sign/sign_in.php'"> </p></div>
             <div><p>
             <input type="button" value = "游客" onclick="location.href='./sign/sign_random.php'"> </p></div>
             <div><p>
             <input type="button" value = "管理员" onclick="location.href='./sign/sign_admin.php'"> </p></div>
	</span>
    <div>
