...
<body>
	...
	<div><p> <b>新用户注册</b></p></div>
			<p><form action="../bin/user_signup.php" method="post">
				<br>
                姓名<br>
				<input type="text" name="name" maxlength=20 required="required"> <br>
				身份证号<br>
				<input type="text" name="userid"maxlength=18 required="required" ><br>
				手机号<br>
				<input type="text" name="usertel" maxlength=11 required="required" ><br>
				信用卡<br>
				<input type="text" name="cardid" maxlength=16 required="required"><br>
				用户名<br>
				<input type="text" name="username" maxlength=20 required="required"><br>
                密码<br>
				<input type="password" name="password" maxlength=16 ><br>
                确认密码<br>
				<input type="password" name="password_re" maxlength=16 ><br>
                头像<br>
				<input type="file" name="userhead" ><br>
                <p><input type="submit" name="注册" value="注册" ><br></p>
			</form></b>
    <div>
