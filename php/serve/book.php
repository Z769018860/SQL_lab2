...
?>
 <b>请输入您需要查询的订单信息</b>
	<form action="../search/book_search.php" method="post">
　	<div><p>出发日期从：<input type="date" name = "from_date_min"  value="<?php echo datadd(-1,date("Y/m/d")); ?>"required = "required"></p></div>
　	<div><p>　　　　至：<input type="date" name = "from_date_max"  value="<?php echo datadd(1,date("Y/m/d")); ?>"required = "required"></p></div>
